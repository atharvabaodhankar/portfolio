          ...
          <section className="swiper">
            ...
            <div className="swiper-wrapper">
              {projects.map((project, index) => (
                <figure key={index} className="swiper-slide">
                  <div className="cardPopout" data-swiper-parallax="30" data-swiper-parallax-scale="0.9"
                    ...
                    <img src={project.image} alt={project.title} width="800" height="400" data-swiper-parallax="80"
                    ...
                    <a href={project.link} target="_blank" rel="noopener noreferrer" title="Visit Now"
